<template>
  <q-page>
    <div class="bg-img flex flex-center gt-sm">
      <div class="text-h2 q-my-auto text-bold container text-white">
        Contact
      </div>
    </div>
    <div
    ...
    >
      <div class="text-h5 q-my-auto text-bold container text-white">
        <u>Contact</u>
      </div>
    </div>
    <div class="container row q-pt-xl q-col-gutter-x-md gt-sm">
      <div class="col-6 q-gutter-y-sm">
        <div class="text-h4 q-py-lg text-bold">KualitySoft</div>
        <div class="row">
          <q-icon name="place" size="24px" class="q-pr-md" />
          <div class="text-subtitle1">Garden Town, Phase 3 Office# 7</div>
        </div>
    ...
    <div class="container row q-pt-xl q-col-gutter-y-md lt-md">
